...
public class ContactRecyclerAdapter extends RecyclerView.Adapter<ContactRecyclerAdapter.ViewHolder> {
    ...
    public ContactRecyclerAdapter(Context context, ArrayList<ContactItem> usersItemArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_contact_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ContactItem users = usersItemArrayList.get(position);

        holder.textName.setText("Nama Lengkap : " + users.getUserName());
        holder.textEmail.setText("Email : " + users.getUserEmail());
        holder.textCountry.setText("Asal Negara : " + users.getUserCountry());
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        ...
                        if (newName.equals(name) && newEmail.equals(email) && newCountry.equals(country)) {
                            ...
                            databaseReference.child("USERS").child(id).setValue(new ContactItem(id, newName, newEmail, newCountry));
